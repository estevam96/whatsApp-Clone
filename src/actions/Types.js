...
export const MODIFICA_NOME = 'modificar_nome';
export const CADASTRA_USUARIO_SUCESSO = 'cadastra_usuario_sucesso';
export const CADASTRA_USUARIO_ERRO = 'cadastro_usuario_erro';
...
export const CADASTRP_EM_ANDAMENTO = 'cadastro_em_andamento';
